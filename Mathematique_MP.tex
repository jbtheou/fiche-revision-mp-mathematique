...
\part{Révisions}
\include{Analyse/revision}
\part{Intégrales, Fonctions}
\setcounter{chapter}{0}
\include{Analyse/integrablegeneralisee}
\include{Analyse/integraleaparametre}
\include{Analyse/approximationuniforme}
\part{Suites, Séries}
\setcounter{chapter}{0}
\include{Analyse/suitedefonctionconvergencesimple}
\include{Analyse/serie}
\include{Analyse/sommationdesrelationsdecomparaison}
\include{Analyse/seriedapplication}
\include{Analyse/serieentier}
\include{Analyse/complementseries}
\include{Algebre/serieendomorphisme}
\part{Équations différentielles}
\setcounter{chapter}{0}
\include{Analyse/equationsdifferentielles}
\part{Réduction d'endomorphismes}
\setcounter{chapter}{0}
\include{Algebre/reductionendomorphisme}
\include{Algebre/reductionendomorphisme2}
\part{Espaces vectoriels normés}
\setcounter{chapter}{0}
\include{Algebre/espacevectorielsnormes}
\include{Algebre/espacevectorielsnormes2}
\include{Algebre/espaceprehilbertien}
\include{Algebre/adjoint}
\include{Algebre/formequadratique}
\include{Algebre/applicationlineairenorme}
\appendix                     % Les annexes
\part{Annexe}
\include{Methodo/integrale}
\include{Methodo/developpementasymptotique}
\include{Methodo/serie}
\include{Algebre/calculmatricielparblocs}
\include{Methodo/quadrique}
\backmatter
